...
public class HitApiImpl implements HitApi {
	...
	public CenterList getCenters(String districtId) {
        ...
        ResponseEntity<CenterList> response = restTemplate.exchange("https://cdn-api.co-vin.in/api/v2/appointment/sessions/calendarByDistrict?district_id="+districtId+"&date=18-05-2021", HttpMethod.GET,entity,CenterList.class);
